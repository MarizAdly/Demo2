...
import com.example.beshoy.demo2.Adapters.User2Adapter;
...
public class UsersActivity extends AppCompatActivity {
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        recView = findViewById ( R.id.recUserV );
        ...
        usersAdapter = new User2Adapter ( userList, this );
